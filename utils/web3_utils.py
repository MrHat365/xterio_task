...
class Web3Utils:
    def __init__(self, http_provider: str, mnemonic: str = None, key: str = None, request_kwargs=None):
        self.w3 = Web3(Web3.HTTPProvider(http_provider, request_kwargs=request_kwargs))
